...
loaded_model = tf.keras.models.load_model('my_model_new.h5')
...
def index():
    ...
    if request.method == 'POST':
        ...
        X_normalized_array = scaler_X.fit_transform(array)
...
if __name__ == '__main__':
    # app.run(host='10.12.49.125', port=5000)
